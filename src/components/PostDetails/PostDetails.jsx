  ...
  return (
    <>
      ...
      {/* <Card className="py-20 bg-gray-800 rounded-xl w-[40rem] mt-3 mx-auto">
        ...
        <GetAllCommentss className="" id={data?.id} />
            
      </Card> */}

      <div className="flex w-[80%] justify-center items-center flex-col mx-auto mt-10">
        ...
        <div className="p-3 rounded-b-2xl border-t border-gray-100 m-2">
           <div className="flex flex-col gap-3 p-2 bg-[#f3f7fc] rounded-xl border border-blue-100/50">
             ...
             <div className="flex flex-col gap-3 px-2 pb-1 pt-3">
                  <p className="text-[14px] text-gray-700 "><GetAllCommentss id={data?.id} /></p>
             </div>
           </div>
        </div>
      </div>
